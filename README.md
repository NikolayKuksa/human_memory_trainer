...
те отображаются кружочки. После исхода времени просмотра, кружочки пропадают, и пользователь
...
Переход на следующий уровень, выход с теста аналогичны к первому тесту.

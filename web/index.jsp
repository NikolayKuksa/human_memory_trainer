...
<table width="100%" height="328"><tr><td class="mainTable"width="434" height="55" valign="top" style="background-color:LightYellow; background: #FFC125; background: linear-gradient(to right,Orange, white); padding: 10px;">
      <ul> <!--Ссылки переходов на тесты памяти-->
         <strong><img usemap="#point" src="img/point.jpg"  name="point" border="0" href="/onCheckboxServlet">
		<MAP name="point">
		...
		<MAP name="word">
            <AREA shape=rect coords=0,0,165,160 title="Переход к тесту на запоминание слов!" HREF="/word.jsp" >
        </MAP></strong> 
          <a href="/word.jsp" onMouseOver="discription(2)" onMouseOut="nod(1)"> Тест на запоминание слов</a>
      </ul></td>

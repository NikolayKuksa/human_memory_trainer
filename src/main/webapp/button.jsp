...
<form name="f" target="myIFR"><!--action="javascript: check_test();">-->
 ...
 <!--ссылка для вывода в таблицу кружочков -->
...
<a class="button"></a>	  
  ...
  <td><font color="#FF0000" size="6"><div id="countdown"></div></font></td></tr><!--Тут отображается ТАЙМЕР-->
    <tr height="50"><td> <input type="button" class="custom-button" value=" На главную " onClick="location.href='main.html'" title="Переход к выбору тестов!"></td></tr>
</table>
